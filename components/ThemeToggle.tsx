...
// كل الألوان اللي تتغير بين الثيمين
const THEMES = {
  light: {
    "--bg-sections": "#ededed",
    "--text-primary": "#0a0a0a",
  ...
  return (
    <button
      ...
      style={{
        ...
        left: "1.2rem",
        zIndex: 9999,
        background: "var(--toggle-bg, rgba(255,255,255,0.85))",
        border: "1.5px solid var(--toggle-border, rgba(0,108,53,0.35))",
        borderRadius: "50%",
        width: "2.7rem",
        height: "2.7rem",
        display: "flex",
        ...
        cursor: "pointer",
        boxShadow: "0 2px 12px var(--toggle-shadow, rgba(0,108,53,0.15))",
        transition: "all .3s cubic-bezier(.22,1,.36,1)",
        backdropFilter: "blur(8px)",
      }}
    >
      {isDark ? (
        <svg style={{ width: "1.3rem", height: "1.3rem", fill: "var(--toggle-icon, #1d8544)" }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
